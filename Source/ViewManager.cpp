...
{
	// Pass the vertical scroll value to the camera to adjust zoom level
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)
	{
		...
		// Reposition camera for a flat, front-on orthographic view
...
void ViewManager::PrepareSceneView()
{
	...
	{
	// Orthographic projection (adjust scale as needed)
		float scale = 10.0f;
		projection = glm::ortho(
			-scale, scale,   // left, right
